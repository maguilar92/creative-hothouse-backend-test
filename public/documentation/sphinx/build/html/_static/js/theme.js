$(document).ready(function () {
    ...
    $(document).on("click", ".accordion.expand .title, .accordion.shrink .title", function () {
        var accordion = $(this).closest(".accordion");
        if ($(accordion).hasClass("expand")) {
            $(accordion).addClass("shrink").removeClass("expand");
        } else {
            $(accordion).addClass("expand").removeClass("shrink");
        }
    });
    // Shift nav in mobile when clicking the menu.
